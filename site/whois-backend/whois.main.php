...
class Whois extends WhoisClient
	...
	function Unknown()
		...
		$result['rawdata'][] = $this->Query['errstr'][] = 'The domain '.$this->Query['query'].' is not yet supported! If you\'d like, we can try and add support for it, please see the "Request a TLD to be Supported" link in our footer.';
		$this->Checkdns($result);
